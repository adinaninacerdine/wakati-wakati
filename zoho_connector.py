...
class ZohoConnector:
    ...
    # ZOHO SHEET
    # --------------------------------------------------------
    def sheet_add_row(self, workbook_id, worksheet_id, row_data):
        url = f"https://sheet.zoho.com/api/v2/{workbook_id}/worksheets/{worksheet_id}/records"
        payload = {'data': json.dumps([row_data])}
